...
<body>
    ...
    <div class="form_container">
        <form class="form_main" action="login_process.php" method="POST">
            ...
            <div class="forgotPassword">
                <a href="recuperar_password.php" class="contraseña">¿Olvidaste tu contraseña?</a>
            </div>
            <button id="button" type="submit" class="btn btn-primary" class="ingresar">Ingresar</button>


            <div class="signupContainer">
                <p>¿No tienes una cuenta?</p>
                <a href="registro.php" class="btn-registrate">Regístrate aquí</a>
            </div>
        </form>
    </div>
